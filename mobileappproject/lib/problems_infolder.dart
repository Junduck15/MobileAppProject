                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                Detail_problemPage(
                                                  foldername:
                                                      widget.foldername,
                                                  problemid : stream.data.docs[index]
                                                  ['id']
                                                )),
                                      )
                                    },
                                                              ...
                                                              Padding(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Text(
                                                                            '1)  ' +
                                                                                stream.data.docs[index]['multipleWrongAnswers'][0],
                                                                            style: TextStyle(
                                                                              fontSize: 17,
                                                                            )),
                                                                        SizedBox(
                                                                        ...
                                                                        Text(
                                                                            '2)  ' +
                                                                                stream.data.docs[index]['multipleWrongAnswers'][1],
                                                                            style: TextStyle(
                                                                              fontSize: 17,
                                                                            )),
                                                                        SizedBox(
                                                                        ...
                                                                        Text(
                                                                            '3)  ' +
                                                                                stream.data.docs[index]['multipleWrongAnswers'][2],
                                                                            style: TextStyle(
                                                                              fontSize: 17,
                                                                            )),
                                                                        SizedBox(
